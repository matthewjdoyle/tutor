...
export const CalculatorIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 15.75V18m-7.5-6.75h.008v.008H8.25v-.008Zm0 2.25h.008v.008H8.25v-.008Zm0 2.25h.008v.008H8.25v-.008Zm0 2.25h.008v.008H8.25v-.008Zm2.25-4.5h.008v.008H10.5v-.008Zm0 2.25h.008v.008H10.5v-.008Zm0 2.25h.008v.008H10.5v-.008Zm2.25-4.5h.008v.008H12.75v-.008Zm0 2.25h.008v.008H12.75v-.008ZM12 21a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
  </svg>
);

export const BeakerIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 2.25a.75.75 0 0 0-.75.75V4.5h-3V3a.75.75 0 0 0-1.5 0V4.5H7.5V3A.75.75 0 0 0 6 3v1.5H3.75A1.5 1.5 0 0 0 2.25 6v1.5H1.5a.75.75 0 0 0 0 1.5h.75V9A.75.75 0 0 0 3 9.75h1.5V12A.75.75 0 0 0 5.25 12.75h1.5V15A.75.75 0 0 0 7.5 15.75h1.5V18A.75.75 0 0 0 9.75 18.75h1.5V21A.75.75 0 0 0 12 21.75h3A.75.75 0 0 0 15.75 21v-2.25h1.5a.75.75 0 0 0 .75-.75V15h1.5a.75.75 0 0 0 .75-.75V12h1.5a.75.75 0 0 0 .75-.75V9h.75a.75.75 0 0 0 .75-.75V7.5h.75a.75.75 0 0 0 .75-.75V6a1.5 1.5 0 0 0-1.5-1.5H18V3a.75.75 0 0 0-.75-.75h-3ZM5.25 6H18.75m-13.5 0V21m13.5-15V21m0-15H5.25m13.5 0V6m0 0V2.25" />
     <path strokeLinecap="round" strokeLinejoin="round" d="M10.057 11.625a1.903 1.903 0 0 0-2.114 0 1.903 1.903 0 0 1-2.114 0A1.828 1.828 0 0 0 4.5 12.375v4.5c0 .647.216 1.256.63 1.755a1.828 1.828 0 0 0 1.329.62h10.084a1.828 1.828 0 0 0 1.329-.62c.414-.5.63-1.108.63-1.755v-4.5c0-.401-.121-.788-.343-1.125a1.903 1.903 0 0 0-2.114 0 1.903 1.903 0 0 1-2.114 0 1.903 1.903 0 0 0-2.114 0Z" />
  </svg>
);
...
export const LightBulbIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.354a15.055 15.055 0 0 1-4.5 0M12 3v2.25m0-2.25a1.5 1.5 0 0 0-1.5 1.5v2.25m1.5-1.5V3m0 0a1.5 1.5 0 0 1 1.5 1.5v2.25m-7.5 7.5H5.25m13.5 0H18.75M5.25 7.5l1.5-1.5m10.5 0L15.75 7.5m-9 4.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0Zm3-6.75V5.25" />
  </svg>
);

export const GlobeAltIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 0 1 7.843 4.582M12 3a8.997 8.997 0 0 0-7.843 4.582m15.686 0A11.953 11.953 0 0 1 12 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0 1 21 12c0 .778-.099 1.533-.284 2.253m0 0A11.978 11.978 0 0 1 12 16.5c-2.998 0-5.74-1.1-7.843-2.918m15.686-2.253A8.959 8.959 0 0 0 3 12c0-.778.099-1.533.284-2.253m15.432 4.506A9.004 9.004 0 0 1 12 13.5c-2.485 0-4.5-4.03-4.5-9s2.015-9 4.5-9m0 18c2.485 0 4.5-4.03 4.5-9s-2.015-9-4.5-9" />
  </svg>
);
...
export const TrashIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12.56 0c1.153 0 2.24.032 3.22.096m9.34-3.712A56.636 56.636 0 0 0 12 2.25a56.636 56.636 0 0 0-7.01 1.03M12 2.25v2.5M4.5 5.25l.75 15A2.25 2.25 0 0 0 7.5 22.5h9a2.25 2.25 0 0 0 2.25-2.25l.75-15M3 5.25h18" />
  </svg>
);
...
export const PresentationChartBarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 0 0 6 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0 1 18 16.5h-2.25m-7.5 0h7.5m-7.5 0-1 3m8.5-3 1 3m0 0-1-3m1 3-1-3m-9 3h10.5a2.25 2.25 0 0 0 2.25-2.25V6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v7.5a2.25 2.25 0 0 0 2.25 2.25Z" />
  </svg>
);
