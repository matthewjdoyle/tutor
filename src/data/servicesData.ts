...
export const courseSections: CourseSection[] = [
  {
    ...
    levels: [
      ...
      {
        id: '16-plus',
        name: '16+ Entrance Exams',
        subjects: ['Maths'],
        description: 'Comprehensive preparation for sixth form entrance exams, focusing on advanced mathematical concepts and problem-solving.',
        imageUrl: 'https://images.unsplash.com/photo-1580582932707-520aed937b7b?q=80&w=1632&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
      },
      {
        id: 'gcse',
  ...
  },
  {
    ...
    levels: [
      ...
      {
        id: 'ib-maths',
        name: 'IB Mathematics (SL & HL)',
        subjects: ['Maths'],
        description: 'Tutoring for IB Maths: Analysis & Approaches and Applications & Interpretation (Standard and Higher Level).',
        imageUrl: 'https://images.unsplash.com/photo-1561135909-0a0d4d7d7c15?q=80&w=2070&auto=format&fit=crop'
      },
      {
        id: 'ib-entrance',
        name: 'IB School Entrance',
  ...
  },
  {
    ...
    levels: [
      ...
      {
        id: 'act-prep',
        name: 'ACT Math & Science Reasoning',
        subjects: ['Math', 'Science'],
        description: 'Targeted preparation and strategies for the ACT Math and Science sections, including timed practice and analytics.',
        imageUrl: 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=2070&auto=format&fit=crop'
      }
    ]
  },
  {
    region: 'Programming Courses',
    levels: [
      {
        id: 'python-beginners',
        name: 'Introduction to Python',
        subjects: ['Programming'],
        description: 'Learn Python fundamentals such as variables, control structures, functions and basic problem-solving. Ideal for complete beginners.',
        imageUrl: 'https://images.unsplash.com/photo-1587620962725-abab7fe55159?q=80&w=2070&auto=format&fit=crop'
      },
      {
        id: 'python-data-viz',
        name: 'Python for Data Visualisation',
        subjects: ['Programming', 'Data Science'],
        description: 'Create compelling charts with Matplotlib, Seaborn and Plotly. Suitable for students comfortable with basic Python.',
        imageUrl: 'https://images.unsplash.com/photo-1556155092-8707de31f9c4?q=80&w=2070&auto=format&fit=crop'
      }
    ]
  }
];
